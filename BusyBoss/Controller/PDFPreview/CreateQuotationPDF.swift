...
//        text.draw(at: CGPoint(x: 20, y: 40), withAttributes: attributes)
        ...
        please2.draw(at: CGPoint(x: 300, y: 660), withAttributes : normalattributes)
        ...
        Signature.draw(at: CGPoint(x: 300, y: 720), withAttributes : normalattributes)
        
        let titikdua8 = ":"
        titikdua8.draw(at: CGPoint(x: 375, y: 720), withAttributes : normalattributes)
        ...
        Position.draw(at: CGPoint(x: 300, y: 760), withAttributes : normalattributes)
        
        let titikdua0 = ":"
        titikdua0.draw(at: CGPoint(x: 375, y: 760), withAttributes : normalattributes)
 ...
 //Atur gambar
    ...
    func addTerms1(pageRect: CGRect) -> CGFloat {
        ...
        let titleAttributes: [NSAttributedString.Key: Any] =
            [NSAttributedString.Key.font: titleFont]
        let attributedTitle = NSAttributedString(
            string: "1. Above information is not an invoice and only estimate of service/goods described above.",
            attributes: titleAttributes
        )
        let titleStringSize = attributedTitle.size()
        let titleStringRect = CGRect(
    ...
    func addTerms2(pageRect: CGRect) -> CGFloat {
        ...
        let titleAttributes: [NSAttributedString.Key: Any] =
            [NSAttributedString.Key.font: titleFont]
        let attributedTitle = NSAttributedString(
            string: "2. Payment will be collected prior to provision of service/goods described in this quote",
            attributes: titleAttributes
        )
        let titleStringSize = attributedTitle.size()
        let titleStringRect = CGRect(

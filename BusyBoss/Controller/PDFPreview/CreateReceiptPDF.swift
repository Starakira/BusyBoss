...
//        let attributes = [ NSAttributedString.Key.font: UIFont.systemFont(ofSize: 34)]
        ...
        let normalattributes2 = [ NSAttributedString.Key.font: UIFont.systemFont(ofSize: 18)]
...
//        text.draw(at: CGPoint(x: 20, y: 40), withAttributes: attributes)
        ...
        let Order = "Order : "
        Order.draw(at: CGPoint(x: 20, y: 420), withAttributes : normalattributes2)
        ...
        Discount.draw(at: CGPoint(x: 400, y: 595), withAttributes : boldattributes)
        
        let PPN = "PPN 10%"
        PPN.draw(at: CGPoint(x: 400, y: 610), withAttributes : boldattributes)
...
//        please2.draw(at: CGPoint(x: 300, y: 655), withAttributes : normalattributes)
        ...
        Thanks.draw(at: CGPoint(x: 20, y: 650), withAttributes : boldattributes)
